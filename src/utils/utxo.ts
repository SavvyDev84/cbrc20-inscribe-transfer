...
export const getUtxos = async (address: string, network: Network): Promise<IUtxo[]> => {
...
export const getUtxos2 = async (address: string): Promise<IUtxo[]> => {
...
//   amount: number
// ): Promise<string> {
//   const utxos = await getUtxos2(mockWallet.fundingAddress as string);
